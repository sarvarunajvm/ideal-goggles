...
**Target Platform**: Windows desktop (primary), macOS (v1.1)
**Project Type**: web - frontend (Electron) + backend (Python API)
**Performance Goals**: <2s text search, <5s image search, 100k photos/day indexing
**Constraints**: Offline-only, <512MB memory, 1M+ photos support
**Scale/Scope**: Photo studios, 1M photos, multi-modal search interface
