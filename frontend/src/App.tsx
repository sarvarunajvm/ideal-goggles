        ...
        <div className="max-w-md w-full">
          ...
          <div className="flex flex-col items-center mb-8">
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-cyan-400 to-teal-400 rounded-full blur-2xl opacity-30 animate-pulse"></div>
              <div className="relative flex items-center justify-center w-20 h-20 bg-gradient-to-r from-cyan-400 to-teal-400 rounded-2xl shadow-2xl shadow-cyan-500/30 animate-bounce">
            ...
            <h1 className="text-3xl font-bold mt-6 bg-gradient-to-r from-cyan-400 to-teal-400 bg-clip-text text-transparent">
              Ideal Goggles
            </h1>
          </div>

          {/* Loading Content */}
          <div className="bg-card/80 backdrop-blur-sm shadow-2xl rounded-2xl p-8 text-center border border-cyan-500/20">
